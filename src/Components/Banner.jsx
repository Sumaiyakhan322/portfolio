...
<div className="hero min-h-screen  bg-cover" style={{backgroundImage: `url(${banner})`}}>
  <div className="hero-overlay bg-opacity-70"></div>
  <div className="hero-content text-center text-neutral-content">
    <div className="flex md:flex-row flex-col justify-between items-center">
     <div className='w-1/2 flex items-center justify-center text-left p-20 '>
     <div>
...
/></span>
      ...
      <button className="btn text-lime-300 bg-black hover:bg-gray-900 rounded-full px-10">Let`s talk</button>
    ...
    <a className="text-3xl hover:scale-125 transition duration-200" href="sumaiya.khan32665@gmail.com"><MdEmail></MdEmail></a>
     ...
     <div className='md:w-1/2  center w-full '>

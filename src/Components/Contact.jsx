...
const Contact = () => {
    ...
    return (
        <div id="contact" className="w-full bg-gradient-to-r from-black to bg-gray-700 md:p-20 pt-10 text-white">
        <h2 className="md:text-4xl text-center font-bold my-10 text-2xl ">Please Contact Me</h2>
           <div className="hero min-h-screen ">
  <div className="hero-content flex-col lg:flex-row-reverse">
    <div className="text-center lg:text-left">
      <h2 className="font-bold text-3xl">Let’s Discuss Your Project</h2>
      <p className="py-6 md:text-lg text-sm">Feel free to get in touch with me for any inquiries, collaboration opportunities, or just to say hello!  i am a passionate MERN stack developer ready to tackle exciting projects and challenges. Reach out through the provided contact form, and I will get back to you as soon as possible. Let is turn your ideas into powerful and efficient web solutions!</p>
      <div className='flex md:gap-6 gap-2 items-center text-lime-300 mt-16'>
    ...
    <div className="card shrink-0  w-full max-w-sm shadow-2xl border border-lime-300">
      <form className="card-body" onSubmit={handleSubmit} data-aos="flip-left">
